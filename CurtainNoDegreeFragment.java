...
public class CurtainNoDegreeFragment extends Fragment {
    int chNum; //代表從哪個CH開啟的
    private static final String TAG = "nodegree";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_curtain_no_degree, container, false);
    }
    //fragment開始的方法
    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        shortcut.setIcon(R.drawable.curtain_icon);
       ...
       /* shortcut.setDeciveCH(deviceCH);
        ...
        new Thread(() -> {
            ...
            ShortcutDataBase.getInstance(getActivity()).getShortcutDataDao().updateTypeWithID(shortcutCheckData.get(0).getId(), "MAX-Drapes");
        }).start();
